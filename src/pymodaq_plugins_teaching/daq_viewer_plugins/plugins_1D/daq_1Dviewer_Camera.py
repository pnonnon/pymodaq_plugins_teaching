...
#        elif ...
    ...
    def ini_detector(self, controller=None):
        ...
        #self.x_axis = Axis(data=data_x_axis, label='Wavelength', units=self._units, index=0)
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        self.dte_signal.emit(DataToExport('myplugin',
                                          data=[DataFromPlugins(name='Camera', data=[data_array],
                                                                dim='Data1D', labels=['Wavelength', 'Intensity'],
                                                                axes=[self.x_axis])]))
