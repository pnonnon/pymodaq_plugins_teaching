...
EXTENSION_NAME = 'Do_Profiling'  # the name that will be displayed in the extension list in the
# dashboard
CLASS_NAME = 'ProfilingExtension'  # this should be the name of your class defined below
...
class ProfilingExtension(gutils.CustomApp):
    ...
    def setup_docks(self):
        ...
        self.docks['XY'] = gutils.Dock('XY name')
        self.dockarea.addDock(self.docks['XY'])
